//
//  ZASenderFeedsViewController.swift
//  Zagil
//
...
class ZASenderFeedsViewController: ZAViewController {
    ...
    private func setupNavigationBar() {
        navigationItem.title = "Shipments Feed"
...
//        navigationItem.rightBarButtonItem = addButton
    ...
    private func loadSenderFeeds(for date: Date) {
        showHud()
        APIClient.getShipments(date: date.getString(of: .dd_MM_YYYY)).done { [weak self] feeds in
...
extension ZASenderFeedsViewController {
    
    @objc
    private func addButtonTapped(_ sender: UIBarButtonItem) {
        push(viewController: ZAAddTripViewController.self, storyboard: R.storyboard.dashboard())
    }
...
extension ZASenderFeedsViewController: DateScrollPickerDelegate {
...
extension ZASenderFeedsViewController: UITableViewDataSource, UITableViewDelegate {
